...
export default function Layout({ children }: LayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'รายรับ-รายจ่าย', href: '/transactions', icon: CreditCard },
    { name: 'งบประมาณ', href: '/budgets', icon: Target },
  ]
        ...
        <div className={`relative flex-1 flex flex-col max-w-xs w-full bg-white transition-transform ${
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">การเงินส่วนตัว</span>
            </div>
